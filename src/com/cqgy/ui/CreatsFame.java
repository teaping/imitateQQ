...
public class CreatsFame extends JFrame  implements Runnable{
	...
	// 好友列表Frame
	private CreateFrameTeST friendsFrame;
	JTextPane txtMainInfo;
	//朋友对象
	private Friend objfriend;
//	private StyledDocument doc = null;

	public CreatsFame(CreateFrameTeST friendsFrame, Map<String, String> user, Map<String, String> friend) throws UnknownHostException {
		...
		this.friendUserName = friend.get("ctreaName");
